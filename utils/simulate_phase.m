...
%rot_angle: the largest rotation angle;
...
for n=1:repeat_num 
    ...
    save([save_path,num2str(n),'_H',num2str(OriNum),'_Matrix_',num2str(a),'.mat'],'H_Matrix');
    
    %% magnetic shift simulation 
    perturb=STI_forward(GT_stitsr,H_Matrix);
    save_nii([save_path,'sim_deltaB',num2str(OriNum),'_',num2str(a),'.mat'],'perturb');
