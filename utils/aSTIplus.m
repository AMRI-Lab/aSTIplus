...
VoxNum = prod(sizeVol);
H0subArray = STIParams.H0subArray.H_Matrix;
deltaBArray = STIParams.PhaseImage.phase_tissue;
BrainMask_temp = STIParams.BrainMask.img;
BrainMask = BrainMask_temp;
CSFMask = STIParams.CSFMask.img;
CSFMask = double(CSFMask);
WM_mask = STIParams.WMMask.img;
